...
// import StatusCard from "../../../common/components/sc-technician/StatusCard";
// import StatusDot from "../../../common/components/sc-technician/StatusDot";
...
import ClaimTable from "../../../common/components/sc-technician/ClaimTable";
import ClaimForm from "../../../common/components/sc-technician/ClaimForm";
import { warrantyClaims } from "../../../../api/warrantyClaims";
import Loader from "../../../../components/Loader";

const ClaimsPage = () => {
  const { rows, loading, error, createClaim, updateClaim, deleteClaim } = warrantyClaims();
    ...
    <div className="p-6">
      ...
      {editing && (
        <ClaimForm
          ...
          onSubmit={(data) => {
            editing.id ? updateClaim(editing.id, data) : createClaim(data);
            setEditing(null);
          }}
